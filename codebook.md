...
### Tidydata.txt
The file “tidydata.txt” contains the mean measurements of all of the features provided in the original data set which can be found at the [UCI Machine Learning Repository](https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip)
